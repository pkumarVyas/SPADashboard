...
function KpiCard({ label, value, iconBg, iconColor, icon, onClick }) {
  return (
    <div className="db-kpi-card" onClick={onClick} style={{ cursor: onClick ? 'pointer' : 'default' }}
         title={onClick ? `Click to filter SPA Import by: ${label}` : undefined}>
    ...
    <>
      ...
      <div className="db-kpi-grid">
        <KpiCard
          ...
          onClick={() => onNavigate('imports', { preset: 'all' })}
        ...
        <KpiCard
          ...
          onClick={() => onNavigate('imports', { preset: 'today' })}
        ...
        <KpiCard
          ...
          onClick={() => onNavigate('imports', { preset: 'success' })}
        ...
        <KpiCard
          ...
          onClick={() => onNavigate('imports', { preset: 'review' })}
